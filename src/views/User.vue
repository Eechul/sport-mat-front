<template>
  <div id="user-container" class="sub-container">
      ...
      <el-col :xs="20" :sm="14" :md="12" :lg="10" :xl="12">
        <el-form
          ...
          <el-form-item label="이메일" prop="email">
            <el-input type="email" v-model="ruleForm.email" placeholder="이메일" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="비밀번호" prop="password">
            <el-input type="password" v-model="ruleForm.password" placeholder="비밀번호"  autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item class="ma0">
            <div class="ma0 txt-left"><a href="" class="non-link">비밀번호를 잊어버리셨나요?<emoji emoji="mag_right" :size="16" /></a></div>
